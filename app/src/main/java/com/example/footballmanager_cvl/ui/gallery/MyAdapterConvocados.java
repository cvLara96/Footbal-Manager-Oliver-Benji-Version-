...
public class MyAdapterConvocados extends RecyclerView.Adapter<MyAdapterConvocados.ViewHolderDatos> {
    ...
    public MyAdapterConvocados(ArrayList<Jugador> listaJugadores, Context context) {
    ...
    public MyAdapterConvocados.ViewHolderDatos onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //DE MANERA QUE AQUI GENERAREMOS UN VIEW INFLADO CON ESE LAYOUT:
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_convocados, null, false);

        return new MyAdapterConvocados.ViewHolderDatos(view);
    }
